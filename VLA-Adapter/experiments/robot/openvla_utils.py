...
def update_auto_map(pretrained_checkpoint: str) -> None:
    ...
    # loading the same Adapter/OFT checkpoint at once): if a prior call
    ...
    # concurrent get_model() call unconditionally re-backs-up and rewrites
    # config.json, racing on the same file. This makes steady-state
